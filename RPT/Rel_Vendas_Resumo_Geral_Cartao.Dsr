VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} Rel_Vendas_Resumo_Geral_Cartao 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Relatório das Vs - Geral"
   ClientHeight    =   7620
   ClientLeft      =   90
   ClientTop       =   435
   ClientWidth     =   15240
   Icon            =   "Rel_Vendas_Resumo_Geral_Cartao.dsx":0000
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   _ExtentX        =   26882
   ...
   EndProperty
End
Attribute VB_Name = "Rel_Vendas_Resumo_Geral_Cartao"
...
Private Sub DataReport_Error(ByVal JobType As MSDataReportLib.AsyncTypeConstants, ByVal Cookie As Long, ByVal ErrObj As MSDataReportLib.RptError, ShowError As Boolean)
    ShowError = False
    MsgBox "Configure o relatorio como paisagem antes de abrir-lo !", vbExclamation
End Sub
